...
class HistogramLogicFilter:
    ...
    def __init__(self):
        ...
        self.match_vector = []
        self.match_pair_vector = []
        self.angle_threshold = None
        self.length_threshold = None

    def fit_gaussian(self, match_vector, match_pair_vector, kp1, kp2, angle_threshold, length_threshold):

        self.match_vector = match_vector
        self.match_pair_vector = match_pair_vector
        ...
        self.angle_histogram = HistogramManager(angle_vec, 50)
        self.length_histogram = HistogramManager(length_vec, 50)
    ...
    def save_configuration(self):
        self.saved_configuration = MatchData(
            self.match_vector, self.match_pair_vector, self.angle_histogram, self.length_histogram)
